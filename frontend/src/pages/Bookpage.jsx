...
const Bookpage = () => {
  ...
  return (
    <div className='min-h-screen text-[#252422] bg-[#f5f5f5] px-4 md:px-12 pb-10'>Bookpage
        ...
        <div className='flex flex-col md:flex-row'>
            ...
            <div className='basis-[65%] mt-6 md:mt-0 md:max-w-4xl'>
                <div className='flex justify-between items-center'>
                    ...
                    {user?._id === book?.user?._id && <div className='text-2xl font-bold -mt-2 relative'>
                        <span 
                        ...
                        {open && <div className='absolute bg-[#f5f5f5] shadow-md pb-2 px-5 text-base font-normal right-0 top-10'>
                            <Link to={`/book/${book._id}/update`}>
                            <p className='mb-2 pb-2 border-b border-gray-300'>Update</p></Link>
